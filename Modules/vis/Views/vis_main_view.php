...
<table><tr valign="top"><td>
    <div style="width:340px; background-color:#efefef; border: 1px solid #ddd;">
        ...
        <div style="padding:5px; display:none;  border-top: 1px solid #fff">
...
<script type="application/javascript">
  ...
  for (z in widgets) {
    ...
    if (widgets[z]['label']!=undefined) label = widgets[z]['label'];
     if (widgets[z]['label'] == 'Zoom')
      continue;
      if (widgets[z]['label'] == 'Stacked')
      continue;
      if (widgets[z]['label'] == 'StackedSolar')
      continue;
      if (widgets[z]['label'] == 'SimpleZoom')
      continue;
      if (widgets[z]['label'] == 'OrderBars')
      continue;
      if (widgets[z]['label'] == 'MultiGraph')
      continue;
      if (widgets[z]['label'] == 'EditRealtime')
      continue;
      if (widgets[z]['label'] == 'Smoothie')
      continue;
      if (widgets[z]['label'] == 'Compare')
      continue;
      if (widgets[z]['label'] == 'Time Comparison')
      continue;
      if (widgets[z]['label'] == 'Timestore Daily (Deprecated)')
      continue;
      if (widgets[z]['label'] == 'Histgraph (Deprecated)')
      continue;
      if (widgets[z]['label'] == 'Threshold (Deprecated)')
      continue;
      if (widgets[z]['label'] == 'OrderThreshold (Deprecated)')
      continue;
      if (widgets[z]['label'] == 'Graph (Deprecated)')
      continue;
      if (widgets[z]['label'] == 'EditDaily')
      continue;
       if (widgets[z]['label'] == 'Histgraph')
      continue;
       if (widgets[z]['label'] == 'Threshold')
      continue;
       if (widgets[z]['label'] == 'OrderThreshold')
      continue;
