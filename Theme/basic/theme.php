...
<head>
    ...
    <title>Energy - <?php echo $route->controller.' '.$route->action.' '.$route->subaction; ?></title>
...
<body class="fullwidth <?php if(isset($page_classes)) echo implode(' ', $page_classes) ?>">
    ...
    <div id="footer">
        <?php echo dgettext('theme_messages','Ngọc Thành - K61M |'); ?>&nbsp;<a href="https://uet.vnu.edu.vn/" target="_blank" rel="noopener">UET - VNU</a>
    </div>
